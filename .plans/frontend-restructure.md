...
```
┌──────────────────────────────────────────────────────────────────────────────┐
│  [logo]  BGX Hard Enduro Championship.        [Търсене…]   КЛАСИРАНЕ  ☾    │
├──────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│                                                                              │
│                            ┌──────────────────┐                              │
...
│                            └──────────────────┘                              │
│                                                                              │
│                  BGX ХАРД ЕНДУРО ШАМПИОНАТ                                   │
│                  НЕОФИЦИАЛНИ РЕЗУЛТАТИ                                       │
│                                                                              │
│         Това са неофициални резултати от Българския Екстремен                │
│         Ендуро Шампионат, събрани от навигационните дни на всяко             │
│         състезание тип Хард Ендуро.                                          │
│                                                                              │
│                       ┌─────────────────────────┐                            │
│                       │      РЕЗУЛТАТИ  →       │   ← /results               │
│                       └─────────────────────────┘                            │
...
│                                                                              │
├──────────────────────────────────────────────────────────────────────────────┤
│                Шампионат БГХ Хард Ендуро · Неофициален · v0.2.0              │
└──────────────────────────────────────────────────────────────────────────────┘
```

One screen, one CTA. Search box stays in the nav for power users who already know a rider's name.

---

### `/results` — default view (no `?race=`, current season's general standings)

URL: `/results` (or `/results?season=2026&category=expert` after the island fills defaults via `replaceState`)
...
│                                                                              │
│  Сезон  ┌──────────┐                                                         │
│         │ 2026  ▾  │   ← dropdown: 2026 / 2025 / 2024                        │
│         └──────────┘                                                         │
│                                                                              │
│  ┌───────┬─────────┬──────────┬─────────────────┬───────┬──────────┬──────┐  │
│  │ ПРОФИ │ ЕКСПЕРТ │ СТАНДАРТ │ СТАНДАРТ-ДЖУНИЪР│ ЖЕНИ  │ СЕНЬ. 40+│ ...  │  │
│  └━━━━━━━┷─────────┴──────────┴─────────────────┴───────┴──────────┴──────┘  │
│   ↑ active                                                                   │
│                                                                              │
│  ┌─────────────────────────┐ ┌────────────────┐ ┌────────────────┐           │
│  │ ★ ГЕНЕРАЛНО КЛАСИРАНЕ  │ │ R1 KYRNARE     │ │ R2 BUHOVO      │  ...      │
│  └─────────────────────────┘ └────────────────┘ └────────────────┘           │
│   ↑ selected (no ?race=)                                                     │
│                                                                              │
│  ┌─────────────────────────────────────────────────────────────────────────┐ │
│  │  Класиране ПРОФИ · Сезон 2026                                           │ │
│  │ ─────────────────────────────────────────────────────────────────────── │ │
│  │  #   №   Състезател               Точки   Участия   Най-добро          │ │
│  │ ─────────────────────────────────────────────────────────────────────── │ │
│  │  1  255  Димитър ТИНЧЕВ            22       1          2     →   row→  │ │
│  │  2  131  Борис ЧАКЪРОВ             18       1          4     →   /rider│ │
│  │  3   13  Любомир СИНЕВ             16       1          5     →   /<slug>│ │
│  │  …                                                                      │ │
│  └─────────────────────────────────────────────────────────────────────────┘ │
└──────────────────────────────────────────────────────────────────────────────┘
```

Three rows of selectors stack horizontally on desktop. Picking a different season replaces the race-buttons row; picking a different category re-renders the table; clicking a rider opens `/rider/<slug>` (full navigation, opens whatever target the user picked — same tab, new tab, etc.).

---

### `/results?season=2025&category=expert&race=buhovo` — race selected

URL: `/results?season=2025&category=expert&race=buhovo`
...
│                                                                              │
│  ┌─────────────────────────┐ ┌────────────┐ ┌──────────────┐ ┌────────────┐  │
│  │   ГЕНЕРАЛНО КЛАСИРАНЕ  │ │ R1 KYRNARE │ │ ★ R2 BUHOVO  │ │ R3 GORNA M.│..│
│  └─────────────────────────┘ └────────────┘ └━━━━━━━━━━━━━━┘ └────────────┘  │
│                                                ↑ selected                    │
│                                                                              │
│  ┌─────────────────────────────────────────────────────────────────────────┐ │
│  │  R2 · HARD ENDURO BUHOVO 2025 — ЕКСПЕРТ                                 │ │
│  │  10 май 2025 · Buhovo, Bulgaria                                         │ │
│  │ ─────────────────────────────────────────────────────────────────────── │ │
│  │  #   №   Състезател             Време        Точки   Обиколки          │ │
│  │ ─────────────────────────────────────────────────────────────────────── │ │
│  │  1  255  Димитър ТИНЧЕВ         3:14:22.50    25         3              │ │
│  │  2  347  Димитър ИЛИЕВ          3:24:15.10    22         3              │ │
│  │  3  107  Калоян ТОДОРОВ         3:31:48.70    20         3              │ │
│  │  …                                                                      │ │
│  └─────────────────────────────────────────────────────────────────────────┘ │
└──────────────────────────────────────────────────────────────────────────────┘
```

Same chrome — only the table swaps. Click "Генерално класиране" to drop `?race=` and bounce back to standings. URL is shareable.

---

### `/rider/<slug>` — multi-season profile

URL: `/rider/димитър-тинчев`
...
│  │ │ #255 │  Димитър ТИНЧЕВ                                                │ │
│  │ └──────┘                                                                │ │
│  │  АЛБА ДАМАСЦЕНА МСК · KTM 300 · ПРОФИ                                  │ │
│  │  Най-добро: 1 · Участия: 7 · Общо точки през кариерата: 311             │ │
│  └─────────────────────────────────────────────────────────────────────────┘ │
│                                                                              │
│  Кариера                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────┐ │
│  │ Сезон   Категория       №      Участия   Най-добро   Точки             │ │
│  │ ─────────────────────────────────────────────────────────────────────── │ │
│  │  2026   ПРОФИ          #255       1          2         22              │ │
│  │  2025   ПРОФИ          #255       1          4         18              │ │
│  │  2025   ЕКСПЕРТ        #255       6          1        159              │ │
│  │  2024   СТАНДАРТ       #255       6          1        152              │ │
│  └─────────────────────────────────────────────────────────────────────────┘ │
│                                                                              │
│  ─── Сезон 2026 · ПРОФИ · #255 ──────────────────────────────────────────    │
│  ┌─────────────────────────────────────────────────────────────────────────┐ │
│  │ Кръг   Състезание                Позиция    Точки    Време              │ │
│  │ ─────────────────────────────────────────────────────────────────────── │ │
│  │  R1    БУХОВО 2026                  2         22     5:40:52.70         │ │
│  └─────────────────────────────────────────────────────────────────────────┘ │
│                                                                              │
│  ─── Сезон 2025 · ЕКСПЕРТ · #255 ───────────────────────────────────────    │
│  ┌─────────────────────────────────────────────────────────────────────────┐ │
│  │ Кръг   Състезание                Позиция    Точки    Време              │ │
│  │ ─────────────────────────────────────────────────────────────────────── │ │
│  │  R1    HARD ENDURO КЪРНАРЕ 2025     1         25     2:55:18.40         │ │
│  │  R2    HARD ENDURO BUHOVO 2025      1         25     3:14:22.50         │ │
│  │  R3    HARD ENDURO GORNA M. 2025    1         37     7:48:12.10         │ │
│  │  R4    EnduroX ALBA-DAMASC. 2025    1         25     2:42:08.00         │ │
│  │  R5    HARD ENDURO STARA Z. 2025    2         22     3:08:55.20         │ │
│  │  R7    SIX DAYS CRAZY JOB 2025      1         25                        │ │
│  └─────────────────────────────────────────────────────────────────────────┘ │
│                                                                              │
│  … (Сезон 2025 · ПРОФИ, then Сезон 2024 · СТАНДАРТ, etc., newest first)     │
│                                                                              │
└──────────────────────────────────────────────────────────────────────────────┘
```

Header card → Career summary table → per-season detail tables, newest first. Each event name is clickable and jumps back to `/results?season=…&category=…&race=…` so the rider page is the natural pivot point: come in for one rider, drill into any race they raced.

---

## State + URL examples

| User action | URL after | What re-renders |
|---|---|---|
| Land on `/results` (defaults applied) | `/results?season=2026&category=expert` | Full island first paint |
| Click "СТАНДАРТ" tab | `/results?season=2026&category=standard` | Just the table |
| Click "R1 BUHOVO" | `/results?season=2026&category=standard&race=buhovo` | Just the table |
| Click "Генерално класиране" | `/results?season=2026&category=standard` | Just the table |
| Open season dropdown → 2025 | `/results?season=2025&category=standard` | Race-buttons row + table |
| Click rider Тинчев | `/rider/димитър-тинчев` (full nav) | New page |
| Browser back | previous URL | Island re-parses + re-renders |
